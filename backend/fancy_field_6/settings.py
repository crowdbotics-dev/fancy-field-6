"""
Django settings for fancy_field_6 project.
...
ROOT_URLCONF = 'fancy_field_6.urls'
...
WSGI_APPLICATION = 'fancy_field_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fancy_field_6 API",
    "DESCRIPTION": "API documentation for fancy_field_6 App",
    "VERSION": "v1",
}
